...
const { data: userSimRS } = useFetch("/api/user/userdata"); //menampilkan di tabel
...
async function editUser(nip) { //item coba diganti nip
  editedIndex.value = dataUser.value.indexOf(nip); 
  editedItem.value = Object.assign({}, nip);
  dialog.value = true;
